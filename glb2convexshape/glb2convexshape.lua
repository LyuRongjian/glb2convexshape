...
function M.generate_convexshape(glb_path)
    ...
    local go_file = io.open(glb.path..".go", "w+")
    io.output(go_file)
    io.write("embedded_components {\n")
    io.write("  id: \"model\"\n")
    io.write("  type: \"model\"\n")
    io.write("  data: \"mesh: \\\""..glb_path.."\\\"\\n\"\n")
    io.write("  \"skeleton: \\\"\\\"\\n\"\n")
    io.write("  \"animations: \\\"\\\"\\n\"\n")
    io.write("  \"default_animation: \\\"\\\"\\n\"\n")
    io.write("  \"name: \\\"{{NAME}}\\\"\\n\"\n")
    io.write("  \"materials {\\n\"\n")
    io.write("  \"  name: \\\"colormap\\\"\\n\"\n")
    io.write("  \"  material: \\\"/builtins/materials/model.material\\\"\\n\"\n")
    io.write("  \"  textures {\\n\"\n")
    io.write("  \"    sampler: \\\"tex0\\\"\\n\"\n")
    io.write("  \"    texture: \\\"/assets/models/Textures/colormap.png\\\"\\n\"\n")
    io.write("  \"  }\\n\"\n")
    io.write("  \"}\\n\"\n")
    io.write("  \"\"\n")
    io.write("  position {\n")
